                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="discription" id="discription" class="form-control" placeholder="Description">{{$discountcoupon->discription}}</textarea>	
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="max_uses" id="max_uses" class="form-control" placeholder="Max Uses" value="{{$discountcoupon->max_uses}}">	
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="max_uses_user" id="max_uses_user" class="form-control" placeholder="Max Uses User" value="{{$discountcoupon->max_uses_user}}">	
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="discount_amount" id="discount_amount" class="form-control" placeholder="Discount Amount" value="{{$discountcoupon->discount_amount}}">	
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="min_amount" id="min_amount" class="form-control" placeholder="min_amount" value="{{$discountcoupon->min_amount}}">	
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="starts_at" id="starts_at" class="form-control" placeholder="Starts At" value="{{$discountcoupon->starts_at}}">	
                                    <p></p>
                                </div>
                            </div>
...
$("#couponForm").submit(function(event){
    ...
    $.ajax({
        url: "{{ route('coupons.update',$discountcoupon->id) }}",  // Make sure the route is correct
        type: 'put',
