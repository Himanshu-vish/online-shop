...
@section('customJs')
 <script>
    ...
    $.ajax({
        url: "{{ route('sub-categories.store') }}",  // Make sure the route is correct
        type: 'POST',
        ...
        error: function(jqXHR, exception) {
            if (jqXHR.status === 422) {
                ...
                if (errors.category) {
                    ...
                    .siblings('p').addClass('invalid-feedback').html(errors.category[0]);  // Show the first error message for category
                }
            } else {
