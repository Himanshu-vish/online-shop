                    ...
                    <div class="card-body">
                        <div class="accordion accordion-flush" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                ...
                                @else
                                <a href="{{route('front.shop', $category->slug)}}" class="nav-item nav-link {{($categorySelected == $category->id) ? 'text-primary' : ''}}">{{$sub_categorySelected}}</a>
                                @endif
                                @if ($category->sub_category->isNotEmpty())
                                    ...
                                    <div class="accordion-body">
                                        <div class="navbar-nav">
                                             @foreach ($category->sub_category as $sub_category) 
                                                  <a href="{{route('front.shop',[$category->slug,$sub_category->slug])}}" class="nav-item nav-link {{($sub_categorySelected == $sub_category->id) ? 'text-primary' : ''}}">{{$sub_category->name}}</a>
                                             @endforeach                                                            
                                        </div>
                                    </div>
                                </div>
...
function apply_filters() {
    ...
    if (brands.length > 0) {
        ...
        var priceMax = slider.result.to;

        // Adding price_min and price_max to URL
        params.set('price_min', priceMin);
        params.set('price_max', priceMax);
    } else {
        // Removing price_min and price_max if no brands are selected
