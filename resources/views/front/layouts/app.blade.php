...
<head>
	...
	.slick-loading .slick-list {
	    background: #fff url('data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7') center center no-repeat;
	}
	</style>
	...
	<div class="container">
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			...
			<div class="col-lg-6 col-6 text-left d-flex justify-content-end align-items-center">
				@auth
					<a href="{{ route('accounts.profile') }}" class="nav-link text-dark">My Account</a>
				@else
					<a href="{{ route('accounts.login') }}" class="nav-link text-dark">Login</a>
				@endauth
			
				<form action="{{ route('front.shop') }}" method="GET">
					<div class="input-group">
						<input type="text" placeholder="Search For Products" value="{{ Request::get('search') }}" class="form-control" name="search">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="footer-card">
					<h3>Get In Touch</h3>
					<p>Himanshu Vishwakarma<br>
					Pratapgarh U P <br>
					himanshu.in@gmail.com <br>
					9789868574</p>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="footer-card">
					<h3>My Account</h3>
					<ul>
						<li><a href="{{route('accounts.login')}}" title="Sell">Login</a></li>
						<li><a href="{{route('accounts.register')}}" title="Advertise">Register</a></li>
						<li><a href="{{route('orders.index')}}" title="Contact Us">My Orders</a></li>						
					</ul>
				</div>
			</div>			
		</div>
...
<div class="modal fade" id="wishlistModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  </div><script src="{{asset('front-assets/js/jquery-3.6.0.min.js')}}"></script>
...
function addToCart(id){
    $.ajax({
       url: '{{route("front.addToCart")}}',  // Make sure the route is correct
       type: 'post',
       data: {id:id},
       dataType: 'json',
...
function addToWishlist(id){
    $.ajax({
       url: '{{route("front.addToWishlist")}}',  // Make sure the route is correct
       type: 'post',
       data: {id:id},
       dataType: 'json',
       success: function(response) {
